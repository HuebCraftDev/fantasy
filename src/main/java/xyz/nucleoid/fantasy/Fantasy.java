...
public final class Fantasy {
    ...
    public static final RegistryKey<MapCodec<? extends ChunkGenerator>> VOID_CHUNK_GENERATOR = RegistryKey.of(RegistryKeys.CHUNK_GENERATOR, Identifier.of(Fantasy.ID, "void"));
    public static final RegistryKey<MapCodec<? extends ChunkGenerator>> TRANSIENT_CHUNK_GENERATOR = RegistryKey.of(RegistryKeys.CHUNK_GENERATOR, Identifier.of(Fantasy.ID, "transient"));
